...
public class ConfusingView extends View {
    private Bitmap eye;
    ...
    public ConfusingView(Context context) {
        super(context);
    }

    public ConfusingView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ConfusingView(Context context, AttributeSet attrs, int defStyleAttr) {
